  ...
  public class UpdateViewModel : PropertyNotifyBase
  {
    ...
    public ICommand LaunchCommand
    {
      get
      {
        ...
        {
          this.launchCommand = new RelayCommand(param => MpBootstrapperApplication.LaunchUrl(this.UpdateUrl), param => this.State == UpdateState.Available && !String.IsNullOrEmpty(this.UpdateUrl));
        }
    ...
    private void worker_DoWork(object sender, DoWorkEventArgs e)
    {
      ...
      try
      {
        HttpWebRequest request = MpBootstrapperApplication.Model.CreateWebRequest("http://wixtoolset.org/releases/feed/v3.6");
        ...
        if (response.StatusCode == HttpStatusCode.OK)
        {
          ...
          Update update = updates.Where(u => u.Version > MpBootstrapperApplication.Model.Version).OrderByDescending(u => u.Version).FirstOrDefault();
          if (update == null)
          {
            this.UpdateUrl = null;
