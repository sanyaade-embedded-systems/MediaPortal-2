...
namespace MediaPortal.InstallerUI.ViewModels.other
{
  ...
  public class RootViewModel : PropertyNotifyBase
  {
    ...
    private ICommand minimzeCommand;
      ...
      get
      {
        if (this.cancelCommand == null)
        {
          this.cancelCommand = new RelayCommand(param =>
          {
            lock (this)
            {
              this.Canceled = (MessageBoxResult.Yes == MessageBox.Show(MpBootstrapperApplication.View, "Are you sure you want to cancel?", "WiX Toolset", MessageBoxButton.YesNo, MessageBoxImage.Error));
            }
          },
