...
namespace MediaPortal.UI.Players.Video
{
  public class BluRayOSDRenderer : IDisposable
  {
    ...
    private readonly Color _transparentColor = Color.FromArgb(0, Color.Black);
    ...
    private Action _onTextureInvalidated;
    ...
    private void InitTexture(BluRayAPI.OSDTexture item)
    {
      ...
      if (_combinedOsdTexture == null || _combinedOsdTexture.Disposed)
      {
        ...
        Rectangle dstRect = new Rectangle(Point.Empty, _fullOsdSize);
      ...
      try
      {
        lock (_syncObj)
        {
          ...
          if (_combinedOsdSurface != null)
          {
            ...
            using (Texture itemTexture = Texture.FromPointer(item.Texture))
      ...
      try
      {
        lock (_syncObj)
        {
          ...
          using (new TemporaryRenderTarget(targetSurface))
          {
            ...
            _sprite.Draw(_combinedOsdTexture, Color.White);
            _sprite.End();
          }
        }
      }
